...
/*
 * Quick ASCII reference (decimal only):
 * '0' = 48    'A' = 65    'a' = 97
 * '9' = 57    'Z' = 90    'z' = 122
 * Space = 32  '(' = 40    ')' = 41    '[' = 91    ']' = 93    '{' = 123   '}' = 125
 *
 *
 * Range	        Decimal Values	    Hex Values
    Digits 0-9	    48 – 57	            30 – 39
    Uppercase A-Z	65 – 90	            41 – 5A
    Lowercase a-z	97 – 122	        61 – 7A
 */
...
public class StringToIntegerManually {
    static void main() {
        char ch1 = '5';
        int int1 = ch1 - '0';
